...
Item {
    ...
    function resolveStyle() {
        switch (root.cornerStyle) {
            case 0:  return hugStyle;
            case 1:  return floatStyle;
            case 2:  return rectStyle;
            case 3:  return diStyle;
            case 4:  return null; // Notch (futuro)
            default: return hugStyle;
        }
    }

    Component { id: hugStyle;   HugStyle   { } }
    Component { id: floatStyle; FloatStyle { } }
    Component { id: rectStyle;  RectStyle  { } }
