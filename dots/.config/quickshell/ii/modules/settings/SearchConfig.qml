...
ContentPage {
    ...
    property bool deferredLoading: false
    Timer {
        running: true
        interval: 150
        onTriggered: page.deferredLoading = true
    }
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        ColumnLayout {
                            ...
                            readonly property var sortedApps: AppSearch.frecencyQuery("")
                                ...
                                Flow {
                                    ...
                                    Repeater {
                                        ...
                                        delegate: Rectangle {
                                            ...
                                            border.width: 1
                                            border.color: chipMouse.containsMouse ? Appearance.colors.colPrimary : Appearance.colors.colOutlineVariant
                                            radius: Appearance.rounding.full
                                ...
                                Flow {
                                    ...
                                    Repeater {
                                        ...
                                        delegate: Rectangle {
                                            ...
                                            border.width: 1
                                            border.color: selected ? Appearance.colors.colPrimary : (builtinMouse.containsMouse ? Appearance.colors.colOutline : Appearance.colors.colOutlineVariant)
                                            radius: Appearance.rounding.full
